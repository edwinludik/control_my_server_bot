...
2. Install it:
   - **Debian/Ubuntu**: `sudo dpkg -i control_my_server_bot_1.1.4_amd64.deb`
   - **RedHat/CentOS/Fedora**: `sudo rpm -i control_my_server_bot-1.1.4.x86_64.rpm`
   - **Arch Linux**: `sudo pacman -U control_my_server_bot-1.1.4-1-x86_64.pkg.tar.zst`
3. Configure the bot:
   Edit `/opt/control_my_server_bot/.env` with your credentials.
